...
(function (z, l) {
    ...
    } var x, v, p, y; l.module("ngMessages", [], function () { x = l.forEach; v = l.isArray; p = l.isString; y = l.element }).info({ angularVersion: "1.7.6" }).directive("ngMessages", ["$animate", function (n) {
